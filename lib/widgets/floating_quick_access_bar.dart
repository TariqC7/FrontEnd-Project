                  ...
                  ...Iterable<int>.generate(items.length).map(
                    (int pageIndex) => Padding(
                      ...
                      child: Card(
                        ...
                        elevation: 4,
                        child: Padding(
                          padding: EdgeInsets.only(top: widget.screenSize.height / 45, bottom: widget.screenSize.height / 45, left: widget.screenSize.width / 20),
                          child: Row(
                            children: [
                              Icon(
                                icons[pageIndex],
                              ...
                              InkWell(
                                ...
                                child: Text(
                                  items[pageIndex],
                                  style: TextStyle(color: Theme.of(context).primaryTextTheme.button!.color, fontSize: 20),
                                ),
                              ),
                            ],
                          ),
